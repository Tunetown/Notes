...
class Tools {
	 ...
	 * (Version 4)
	 * p: Blending percentage (p) range is 0.0 to 1.0. Shading percentage range is -1.0 to 1.0, negative p shades to black, positive p shades to white.
	 * l: Linear mode (bool)
	 */
	static blendColors(p, c0, c1, l) {
