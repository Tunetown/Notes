...
const APP_SOURCE_DEFINITIONS = [
    ...
    { src: './ui/app/src/pages/Conflicts.js', tag: 'script', type: 'text/javascript' },
    { src: './ui/app/src/pages/LabelDefinitions.js', tag: 'script', type: 'text/javascript' },
    ...
    { src: './ui/app/src/pages/GraphView.js', tag: 'script', type: 'text/javascript' },
    { src: './ui/app/src/pages/Settings.js', tag: 'script', type: 'text/javascript' },
    { src: './ui/app/src/pages/Check.js', tag: 'script', type: 'text/javascript' },
    { src: './ui/app/src/pages/CheckList.js', tag: 'script', type: 'text/javascript' },
    { src: './ui/app/src/pages/Refs.js', tag: 'script', type: 'text/javascript' },
    { src: './ui/app/src/pages/Help.js', tag: 'script', type: 'text/javascript' },
    { src: './ui/app/src/pages/Update.js', tag: 'script', type: 'text/javascript' },
    { src: './ui/app/src/pages/Generate.js', tag: 'script', type: 'text/javascript' },
    { src: './ui/app/src/pages/VerifyBackup.js', tag: 'script', type: 'text/javascript' },
