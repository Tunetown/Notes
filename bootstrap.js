...
const APP_SOURCE_DEFINITIONS = [
    ...
    { src: './ui/app/src/model/Data.js', tag: 'script', type: 'text/javascript' },
    { src: './ui/app/src/model/Linkage.js', tag: 'script', type: 'text/javascript' },
    { src: './ui/app/src/model/Hashtag.js', tag: 'script', type: 'text/javascript' },
    { src: './ui/app/src/model/Document.js', tag: 'script', type: 'text/javascript' },
    { src: './ui/app/src/model/DocumentAccess.js', tag: 'script', type: 'text/javascript' },
    { src: './ui/app/src/model/DocumentChecks.js', tag: 'script', type: 'text/javascript' },
    { src: './ui/app/src/model/Views.js', tag: 'script', type: 'text/javascript' },
    { src: './ui/app/src/model/Generator.js', tag: 'script', type: 'text/javascript' },
